...
# Title: punto_1_muestreo_Nyquist
# Author: uis-e3t(Maria_Natalia)
...
class practica_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "punto_1_muestreo_Nyquist")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("punto_1_muestreo_Nyquist")
